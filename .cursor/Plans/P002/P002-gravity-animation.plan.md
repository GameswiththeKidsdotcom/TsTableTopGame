...
| ------- | ---------------------- | ------------- | ------------------------------------------------------------------------------------------------------------------------------- | ---------------- |
| P002    | Gravity drop animation | 2             | Animated gravity when matches cleared; pips drop slowly to final position. Plan: `.cursor/Plans/P002/P002-gravity-animation.plan.md` | Pending analysis |
...
**Plan location:** Move/copy plan to `.cursor/Plans/P002/P002-gravity-animation.plan.md` (workspace) for Master-Plan consistency. Link from matrix.

**Sub-plans:** P002 has 4 chunks (G1–G4); single file acceptable. If plan grows, split into `.cursor/Plans/P002/G1-gravity-delta.plan.md`, etc.
...
5. **Plan file path:** Planner notes move to `.cursor/Plans/P002/P002-gravity-animation.plan.md` for matrix consistency.
