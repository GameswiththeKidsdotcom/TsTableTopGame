...
**P004 P5 — Tests.** Plan: [P004-power-up.plan.md](.cursor/Plans/P004-power-up.plan.md). Sub-plan: [P5-tests.plan.md](.cursor/Plans/P004/P5-tests.plan.md). Builder: Unit tests for purchase, use effects, Double Cash. Fixture-based integration test. Logic-Test validation.
