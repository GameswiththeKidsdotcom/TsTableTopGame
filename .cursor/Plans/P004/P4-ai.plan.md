...
**P004 P4 — AI.** Plan: [P004-power-up.plan.md](.cursor/Plans/P004-power-up.plan.md). Sub-plan: [P4-ai.plan.md](.cursor/Plans/P004/P4-ai.plan.md). Builder: Extend AISnapshot with cash, powerUpHeld, opponentEliminated; add usePowerUpBeforeMove and purchase logic to GreedyAI; GameScene AI turn calls use then purchase then move.
