...
**P004 P3 — UI.** Plan: [P004-power-up.plan.md](.cursor/Plans/P004-power-up.plan.md). Sub-plan: [P3-ui.plan.md](.cursor/Plans/P004/P3-ui.plan.md). Builder: Extend GameStateDisplay with power-up fields; GameScene exposes tryPurchasePowerUp/tryUsePowerUp; HUDOverlay shows purchase and use buttons. UI-Test checkpoint after P3.
