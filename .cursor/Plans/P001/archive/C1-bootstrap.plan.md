...
|------|------|------------|
| 1 | Create `docs/SPEC.md` with: 6-player targeting (Option B), cash (1/virus, no chain bonus), coord system (origin top-left, row 0=spawn, cols 0–7), offline-only, virus count formula | SPEC exists |
