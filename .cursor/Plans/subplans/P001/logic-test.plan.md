...
| C7 - Perfected | Garbage targeting when eliminated; colors match; **garbagePositions contract (count 1..4 → non-empty)**; **1-clear integration (opponent receives visible garbage via gridState)** |
