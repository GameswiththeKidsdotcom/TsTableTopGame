...
Per [.cursor/agents/e2e-harness.md](../../../agents/e2e-harness.md): design-only output (journey map, viewport matrix, user-usable objects, handoffs). Aligns with [ui-test.plan.md](ui-test.plan.md) and [C10-validation-chunks.plan.md](C10-validation-chunks.plan.md).
...
- [e2e-harness.md](../../../agents/e2e-harness.md), [ui-test.plan.md](ui-test.plan.md), [C10-validation-chunks.plan.md](C10-validation-chunks.plan.md)
