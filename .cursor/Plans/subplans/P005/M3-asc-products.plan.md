...
**Next hand off (cut & paste)**: **P005 M3 — ASC Products.** [M3-asc-products.plan.md](.cursor/Plans/subplans/P005/M3-asc-products.plan.md). Human/Builder: Create IAP product in App Store Connect (In-App Purchases); update asc-setup-runbook.md age rating to In-App Purchases = Yes.
...
3. **Update asc-setup-runbook.md**  
   - Path: [asc-setup-runbook.md](.cursor/Plans/subplans/P001-C11/asc-setup-runbook.md)  
