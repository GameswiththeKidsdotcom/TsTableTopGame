...
**Next hand off (cut & paste)**: **P005 M4 — StoreKit Testing.** [M4-storekit-testing.plan.md](.cursor/Plans/subplans/P005/M4-storekit-testing.plan.md). Investigator: validate M4 for 90%+ confidence. Builder: Create StoreKit Configuration file; add entitlement unit tests. Logic-Test: confirm test coverage for entitlement and mocked purchase flow.
