...
**Next hand off (cut & paste)**: **P005 M5 — Ads after win.** [M5-ads-after-win.plan.md](.cursor/Plans/subplans/P005/M5-ads-after-win.plan.md). Investigator: validate M5 for 90%+ confidence. Builder: Integrate AdMob or Unity Ads; show interstitial or rewarded ad in GameOverOverlay / post-win flow when !IAPManager.shared.hasPremium.
