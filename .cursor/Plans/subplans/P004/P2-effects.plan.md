...
**P004 P2 — Effects.** Plan: [P004-power-up.plan.md](.cursor/Plans/subplans/P004/P004-power-up.plan.md). Sub-plan: [P2-effects.plan.md](.cursor/Plans/subplans/P004/P2-effects.plan.md). Builder: Implement Clear Row, Send Garbage, Double Cash in `tryUsePowerUp` and `lockCapsule`/resolution. Unit tests per effect. Logic-Test checkpoint after P2.
