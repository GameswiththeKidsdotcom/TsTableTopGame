...
**Next hand off (cut & paste)**: **P005 M2 — Paywall UI.** [M2-paywall-ui.plan.md](.cursor/Plans/P005/M2-paywall-ui.plan.md). Investigator: validate M2 for 90%+ confidence. Builder: add purchase and restore buttons in SettingsView; wire to IAPManager.shared; show/hide based on hasPremium.
